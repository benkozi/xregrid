...
- **High Performance**: Up to 600x faster than xESMF for certain grid configurations
- **Full Grid Support**: Rectilinear, curvilinear, and unstructured grids (MPAS, ICON)
